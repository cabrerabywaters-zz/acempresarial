...
ENDPAGE=1 # set to pagenumber of the last page of PDF you wish to convert
SOURCE=C_Tributaria_Copol.pdf # set to the file name of the PDF
...
for i in `seq $STARTPAGE $ENDPAGE`; do
    ...
    tesseract page.tif -l spa tempoutput
